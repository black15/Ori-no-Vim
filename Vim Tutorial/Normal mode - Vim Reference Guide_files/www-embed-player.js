...
c.prototype=b.prototype;a.X=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.tr=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Lr;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.hb}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
l.hc=function(){this.h()||(this.P||this.s||this.j?Wg(this):this.Zc())};
l.Zc=function(){Wg(this)};
function Wg(a){if(a.i&&"undefined"!=typeof Na)if(a.I[1]&&4==Zg(a)&&2==a.getStatus())a.getStatus();else if(a.s&&4==Zg(a))Tf(a.hc,0,a);else if(ef(a,"readystatechange"),a.isComplete()){a.getStatus();a.i=!1;try{if($g(a))ef(a,"complete"),ef(a,"success");else{try{var b=2<Zg(a)?a.A.statusText:""}catch(c){b=""}a.m=b+" ["+a.getStatus()+"]";Ug(a)}}finally{Vg(a)}}}
...
var lj=[12];var mj=new Si("continuationCommand");var nj=new Si("webCommandMetadata");var oj=new Si("signalServiceEndpoint");var pj={ti:"EMBEDDED_PLAYER_MODE_UNKNOWN",oi:"EMBEDDED_PLAYER_MODE_DEFAULT",si:"EMBEDDED_PLAYER_MODE_PFP",ri:"EMBEDDED_PLAYER_MODE_PFL"};var qj=new Si("feedbackEndpoint");var rj={Sq:"WEB_DISPLAY_MODE_UNKNOWN",Oq:"WEB_DISPLAY_MODE_BROWSER",Qq:"WEB_DISPLAY_MODE_MINIMAL_UI",Rq:"WEB_DISPLAY_MODE_STANDALONE",Pq:"WEB_DISPLAY_MODE_FULLSCREEN"};function sj(a){H.call(this,a,-1,tj)}
...
351,352,353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439,441,448];var gk={tj:0,ej:1,kj:2,lj:4,qj:8,mj:16,nj:32,sj:64,rj:128,gj:256,ij:512,pj:1024,hj:2048,jj:4096,fj:8192,oj:16384};function hk(a){H.call(this,a)}
...
a);
if("AbortError"===e.name)return new Cm("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",ic:e.name})];e.level="WARNING";return e}
...
function Vm(a,b,c,d){var e,f,g,h,k,m,q,r,w,t,A,E;return x(function(F){switch(F.h){case 1:var O={mode:"readonly",R:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?O.mode=c:Object.assign(O,c);e=O;a.transactionCount++;f=e.R?3:1;g=0;case 2:if(h){F.u(3);break}g++;k=Math.round(R());za(F,4);m=a.h.transaction(b,e.mode);O=new Zm(m);O=$m(O,d);return v(F,O,6);case 6:return q=F.i,r=Math.round(R()),an(a,k,r,g,void 0,b.join(),e),F.return(q);case 4:w=Ba(F);t=Math.round(R());A=Gm(w,a.h.name,b.join(),a.h.version);
...
function mn(a,b){b=void 0===b?{}:b;var c,d,e,f;return x(function(g){if(1==g.h)return za(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.Fc)&&c.addEventListener("blocked",function(){e()}),v(g,Qm(c),4);
...
function Wn(a,b,c){var d,e,f;return x(function(g){switch(g.h){case 1:return d={config:a,hashData:b,timestamp:R()},v(g,Vn(c),2);case 2:return e=g.i,v(g,e.clear("hotConfigStore"),3);case 3:return v(g,Ym(e,"hotConfigStore",d),4);case 4:return f=g.i,g.return(f)}})}
function Xn(a,b,c,d){var e,f,g;return x(function(h){switch(h.h){case 1:return e={config:a,hashData:b,configData:c,timestamp:R()},v(h,Vn(d),2);case 2:return f=h.i,v(h,f.clear("coldConfigStore"),3);case 3:return v(h,Ym(f,"coldConfigStore",e),4);case 4:return g=h.i,h.return(g)}})}
...
e);return b}
function mo(a){var b=new kj,c=new bj;D(c,1,a.dc);D(c,2,a.cc);D(c,16,a.Sc);D(c,17,a.innertubeContextClientVersion);if(a.xb){var d=a.xb,e=new Yi;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Yi,62,e)}(d=y.devicePixelRatio)&&1!=d&&D(c,65,d);d=Uk();""!==d&&D(c,54,d);d=Vk();if(0<d.length){e=new dj;for(var f=0;f<d.length;f++){var g=new Wi;D(g,1,d[f].key);Vd(g,2,Xi,d[f].value);ce(e,15,Wi,g)}G(b,
...
function go(a,b,c){a=a.ac;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Xd(b,Zi,96)||new Zi;var d=Hl();d=Object.keys(rj).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);G(b,Zi,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Hl())}
...
function no(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.sr||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().rr:b=xg([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
function ro(a,b,c,d){if(d)return null;d=qo().get("nextId",!0)||1;var e=qo().get("requests",!0)||{};e[d]={method:a,request:b,authState:oo(c),requestTime:Math.round(R())};qo().set("nextId",d+1,86400,!0);qo().set("requests",e,86400,!0);return d}
function so(a){var b=qo().get("requests",!0)||{};delete b[a];qo().set("requests",b,86400,!0)}
function to(a){var b=qo().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(R())-d.requestTime)){var e=d.authState,f=oo(no(!1));ub(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(R())),uo(a,d.method,e,{}));delete b[c]}}qo().set("requests",b,86400,!0)}}
...
a.Db;this.Cb=a.Cb;wo(this)&&(!this.J||this.J("networkless_logging"))&&xo(this)}
function xo(a){wo(a)&&!a.Ia&&(a.h=!0,a.fb&&Math.random()<=a.eb&&a.N.Hc(a.H),yo(a),a.L.U()&&a.Pa(),a.L.ha(a.Db,a.Pa.bind(a)),a.L.ha(a.Cb,a.Qb.bind(a)))}
...
l.Pa=function(){var a=this;if(!wo(this))throw Hm("throttleSend");this.i||(this.i=this.Y.S(function(){var b;return x(function(c){if(1==c.h)return v(c,a.N.Zb("NEW",a.H),2);if(3!=c.h)return b=c.i,b?v(c,zo(a,b),3):(a.Qb(),c.return());a.i&&(a.i=0,a.Pa());c.h=0})},this.sc))};
l.Qb=function(){this.Y.da(this.i);this.i=0};
function zo(a,b){var c,d;return x(function(e){switch(e.h){case 1:if(!wo(a))throw c=Hm("immediateSend"),c;if(void 0===b.id){e.u(2);break}return v(e,a.N.Xc(b.id,a.H),3);case 3:(d=e.i)?b=d:a.Ba(Error("The request cannot be found in the database."));case 2:if(Bo(a,b,a.lc)){e.u(4);break}a.Ba(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return v(e,a.N.Aa(b.id,a.H),5);case 5:return e.return();case 4:b.skipRetry||(b=Co(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
...
function yo(a){if(!wo(a))throw Hm("retryQueuedRequests");a.N.Zb("QUEUED",a.H).then(function(b){b&&!Bo(a,b,a.jc)?a.Y.S(function(){return x(function(c){if(1==c.h)return void 0===b.id?c.u(2):v(c,a.N.Hb(b.id,a.H),2);yo(a);c.h=0})}):a.L.U()&&a.Pa()})}
function Ao(a,b){a.xc&&!a.L.U()?a.xc(b):a.handleError(b)}
...
function Uo(a,b){var c,d,e,f;return x(function(g){if(1==g.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},v(g,To(b),2);if(3!=g.h)return d=g.i,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:L("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),v(g,Ym(d,"LogsRequestsStore",e),3);f=g.i;c.xd=R();Vo(c);return g.return(f)})}
function Wo(a,b){var c,d,e,f,g,h,k;return x(function(m){if(1==m.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},v(m,To(b),2);if(3!=m.h)return d=m.i,e=L("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,R()],h=IDBKeyRange.bound(f,g),k=void 0,v(m,Vm(d,["LogsRequestsStore"],{mode:"readwrite",R:!0},function(q){return hn(q.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(r){r.getValue()&&(k=r.getValue(),"NEW"===a&&(k.status="QUEUED",
r.update(k)))})}),3);
c.xd=R();Vo(c);return m.return(k)})}
...
function $o(a){var b,c;return x(function(d){if(1==d.h)return v(d,To(a),2);b=d.i;c=R()-2592E6;return v(d,Vm(b,["LogsRequestsStore"],{mode:"readwrite",R:!0},function(e){return en(e.objectStore("LogsRequestsStore"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
function ep(a){var b,c;x(function(d){if(1==d.h)return v(d,dp(a),2);b=d.i;c=R()-2592E6;return v(d,Vm(b,["SWHealthLog"],{mode:"readwrite",R:!0},function(e){return en(e.objectStore("SWHealthLog"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
function rp(a,b){a.mb?a.i?(ei.da(a.o),a.o=ei.S(function(){a.m!==b&&(ef(a,b),a.m=b,a.i=R())},a.mb-(R()-a.i))):(ef(a,b),a.m=b,a.i=R()):ef(a,b)}
;var sp;function tp(){var a=vo.call;sp||(sp=new qp({Er:!0,yr:!0}));a.call(vo,this,{N:{Hc:$o,Aa:Zo,Zb:Wo,Xc:Xo,Hb:Yo,set:Uo},L:sp,handleError:Zk,Ba:$k,ia:up,now:R,xc:np,Y:dm(),Db:"publicytnetworkstatus-online",Cb:"publicytnetworkstatus-offline",fb:!0,eb:.1,kb:Tk("potential_esf_error_limit",10),J:M,Ia:!(em()&&vp())});this.j=new Eh;M("networkless_immediately_drop_all_requests")&&ap();Pn("LogsDatabaseV2")}
...
function up(a,b,c){M("use_cfr_monitor")&&yp(a,b);if(M("use_request_time_ms_header"))b.headers&&(b.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(R())));else{var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(R())}if(c&&0===Object.keys(b).length){var e=void 0===e?"":e;var f=void 0===f?!1:f;if(a)if(e)Bl(a,void 0,"POST",e);else if(L("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))Bl(a,void 0,"GET","",void 0,void 0,f);else{b:{try{var g=new cb({url:a});if(g.j&&g.i||
...
;var Mp=!1,kq=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:Mp};z("ytNetworklessLoggingInitializationOptions",kq);function lq(){var a;x(function(b){if(1==b.h)return v(b,En(),2);a=b.i;if(!a||!em()&&!M("nwl_init_require_datasync_id_killswitch")||!vp())return b.u(0);Mp=!0;kq.isNwlInitialized=Mp;return v(b,wp().awaitInitialization(),0)})}
...
function uo(a,b,c,d){function e(A){A=void 0===A?!1:A;var E;if(d.retry&&"www.youtube-nocookie.com"!=h&&(A||M("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(E=ro(b,c,m,k)),E)){var F=g.onSuccess,O=g.onFetchSuccess;g.onSuccess=function(N,Q){so(E);F(N,Q)};
c.onFetchSuccess=function(N,Q){so(E);O(N,Q)}}try{A&&d.retry&&!d.fc.bypassNetworkless?(g.method="POST",d.fc.writeThenSend?wp().writeThenSend(t,g):wp().sendAndWrite(t,g)):M("web_all_payloads_via_jspb")?yl(t,g):(g.method="POST",g.postParams||(g.postParams={}),yl(t,g))}catch(N){if("InvalidAccessError"==N.name)E&&(so(E),E=0),$k(Error("An extension is blocking network request."));
...
kq.isNwlInitialized:Mp)?Cn().then(function(A){e(A)}):e(!1)}
...
function Aq(a){var b=void 0===a?{}:a;a=void 0===b.cd?!1:b.cd;b=void 0===b.Mc?!0:b.Mc;if(null==B("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&Bq();vq(document,"keydown",Bq);vq(document,"keyup",Bq);vq(document,"mousedown",Bq);vq(document,"mouseup",Bq);a?vq(window,"touchmove",function(){Cq("touchmove",200)},{passive:!0}):(vq(window,"resize",function(){Cq("resize",200)}),b&&vq(window,"scroll",function(){Cq("scroll",200)}));
...
function Tq(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.h.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.h.get(b);c.push(b);if(d.vc)var e=d.vc;else if(d.Ad)e=d[Oq]?Uq(a,d[Oq],c):[],e=d.Ad.apply(d,ja(e));else if(d.uc){e=d.uc;var f=e[Oq]?Uq(a,e[Oq],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ja(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.Or||a.i.set(b,e);return e}
...
function tr(a,b,c,d,e){d=void 0===d?!1:d;a&&(er=new a);a=Tk("tvhtml5_logging_max_batch_ads_fork")||Tk("tvhtml5_logging_max_batch")||Tk("web_logging_max_batch")||100;var f=R(),g=d?hr.j:gr.j;b=b.length;e&&(b=pr().getSequenceCount(e));b>=a?ir||(ir=vr(function(){wr({writeThenSend:!0},M("flush_only_full_queue")?c:void 0,d);ir=void 0},0)):10<=f-g&&(xr(d),d?hr.j=f:gr.j=f)}
...
function Hr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,fc:a,dangerousLogToVisitorSession:b,ur:!!e,headers:{},postBodyFormat:"",postBody:""};Lr()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(R())));return a}
...
;function rm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts")){c=void 0===c?{}:c;var d=mq;L("ytLoggingEventsDefaultDisabled",!1)&&mq===mq&&(d=null);M("web_all_payloads_via_jspb")?Rr.push({Eb:a,payload:b,options:c}):Or(a,b,d,c)}else d=mq,L("ytLoggingEventsDefaultDisabled",!1)&&mq==mq&&(d=null),Or(a,b,d,c)}
;var as=[{Bb:function(a){return"Cannot read property '"+a.key+"'"},
...
jb:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var cs={ma:[],ka:[{callback:bs,weight:500}]};function bs(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function ds(){this.ka=[];this.ma=[]}
var es;function fs(){if(!es){var a=es=new ds;a.ma.length=0;a.ka.length=0;cs.ma&&a.ma.push.apply(a.ma,cs.ma);cs.ka&&a.ka.push.apply(a.ka,cs.ka)}return es}
;var gs=new K;function hs(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=is(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=is(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=is(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function is(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function js(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=ks(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=hs(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?ks(e+".ve",f,g,h):0;d+=g;d+=ks(e,a[e],b,c);if(500<d)break}}else c[b]=ls(a),d+=c[b].length;else c[b]=ls(a),d+=c[b].length;return d}
function ks(a,b,c,d){c+="."+a;a=ls(b);d[c]=a;return c.length+a.length}
function ls(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var ms=new Set,ns=0,os=0,ps=0,qs=[],rs=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function qm(a){ss(a)}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=ns)){var m=qs,q=xe(a),r=q.message||"Unknown Error",w=q.name||"UnknownError",t=q.stack||a.i||"Not available";if(t.startsWith(w+": "+r)){var A=t.split("\n");A.shift();t=A.join("\n")}var E=q.lineNumber||"Not available",F=q.fileName||"Not available",O=t,N=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var Q=0;Q<a.args.length&&!(N=js(a.args[Q],"params."+Q,g,N),500<=N);Q++);else if(a.hasOwnProperty("params")&&
a.params){var ca=a.params;if("object"===typeof a.params)for(var U in ca){if(ca[U]){var sb="params."+U,Wa=ls(ca[U]);g[sb]=Wa;N+=sb.length+Wa.length;if(500<N)break}}else g.params=ls(ca)}if(m.length)for(var oa=0;oa<m.length&&!(N=js(m[oa],"params.context."+oa,g,N),500<=N);oa++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var I={message:r,name:w,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},ma=Number(a.columnNumber);isNaN(ma)||(I.lineNumber=I.lineNumber+
":"+ma);if("IGNORED"===a.level)var ea=0;else a:{for(var Ge=fs(),He=p(Ge.ma),sd=He.next();!sd.done;sd=He.next()){var ra=sd.value;if(I.message&&I.message.match(ra.Fr)){ea=ra.weight;break a}}for(var zp=p(Ge.ka),kk=zp.next();!kk.done;kk=zp.next()){var Ap=kk.value;if(Ap.callback(I)){ea=Ap.weight;break a}}ea=1}I.sampleWeight=ea;for(var Bp=p(as),lk=Bp.next();!lk.done;lk=Bp.next()){var mk=lk.value;if(mk.jb[I.name])for(var Cp=p(mk.jb[I.name]),nk=Cp.next();!nk.done;nk=Cp.next()){var Dp=nk.value,Xg=I.message.match(Dp.regexp);
if(Xg){I.params["params.error.original"]=Xg[0];for(var ok=Dp.groups,Ep={},td=0;td<ok.length;td++)Ep[ok[td]]=Xg[td+1],I.params["params.error."+ok[td]]=Xg[td+1];I.message=mk.Bb(Ep);break}}}I.params||(I.params={});var Fp=fs();I.params["params.errorServiceSignature"]="msg="+Fp.ma.length+"&cb="+Fp.ka.length;I.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(I.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(I.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(I);if(0!==I.sampleWeight&&!ms.has(I.message)){if("ERROR"===h){gs.ra("handleError",I);if(M("record_app_crashed_web")&&0===ps&&1===I.sampleWeight)if(ps++,M("errors_via_jspb")){var pk=new Dj;D(pk,1,1);if(!M("report_client_error_with_app_crash_ks")){var Gp=new yj;D(Gp,1,I.message);var Hp=new zj;G(Hp,yj,3,Gp);var Ip=new Aj;G(Ip,zj,5,Hp);var Jp=new Bj;G(Jp,Aj,9,Ip);G(pk,Bj,4,Jp)}var Kp=new ek;ae(Kp,Dj,20,
fk,pk);Ur(Kp)}else{var Lp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Lp.systemHealth={crashData:{clientError:{logMessage:{message:I.message}}}});rm("appCrashed",Lp)}os++}else"WARNING"===h&&gs.ra("handleWarning",I);if(M("kevlar_gel_error_routing"))a:{var Ie=h;if(M("errors_via_jspb")){if(us())var Np=void 0;else{var ud=new vj;D(ud,1,I.stack);I.fileName&&D(ud,4,I.fileName);var Kb=I.lineNumber&&I.lineNumber.split?I.lineNumber.split(":"):[];0!==Kb.length&&(1!==
Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(D(ud,2,Number(Kb[0])),D(ud,3,Number(Kb[1]))):D(ud,2,Number(Kb[0])));var zc=new yj;D(zc,1,I.message);D(zc,3,I.name);D(zc,6,I.sampleWeight);"ERROR"===Ie?D(zc,2,2):"WARNING"===Ie?D(zc,2,1):D(zc,2,0);var qk=new wj;D(qk,1,!0);ae(qk,vj,3,xj,ud);var bc=new sj;D(bc,3,window.location.href);for(var Op=L("FEXP_EXPERIMENTS",[]),rk=0;rk<Op.length;rk++){var nw=Op[rk];Fd(bc);Ud(bc,5,2,!1,!1).push(nw)}var sk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Rk()&&sk)for(var Pp=p(Object.keys(sk)),Ac=Pp.next();!Ac.done;Ac=Pp.next()){var Qp=Ac.value,tk=new uj;D(tk,1,Qp);D(tk,2,String(sk[Qp]));ce(bc,4,uj,tk)}var uk=I.params;if(uk){var Rp=p(Object.keys(uk));for(Ac=Rp.next();!Ac.done;Ac=Rp.next()){var Sp=Ac.value,vk=new uj;D(vk,1,"client."+Sp);D(vk,2,String(uk[Sp]));ce(bc,4,uj,vk)}}var Tp=L("SERVER_NAME"),Up=L("SERVER_VERSION");if(Tp&&Up){var wk=new uj;D(wk,1,"server.name");D(wk,2,Tp);ce(bc,4,uj,wk);var xk=new uj;D(xk,1,"server.version");D(xk,2,Up);ce(bc,
4,uj,xk)}var Yg=new zj;G(Yg,sj,1,bc);G(Yg,wj,2,qk);G(Yg,yj,3,zc);Np=Yg}var Vp=Np;if(!Vp)break a;var Wp=new ek;ae(Wp,zj,163,fk,Vp);Ur(Wp)}else{if(us())var Xp=void 0;else{var Je={stackTrace:I.stack};I.fileName&&(Je.filename=I.fileName);var Lb=I.lineNumber&&I.lineNumber.split?I.lineNumber.split(":"):[];0!==Lb.length&&(1!==Lb.length||isNaN(Number(Lb[0]))?2!==Lb.length||isNaN(Number(Lb[0]))||isNaN(Number(Lb[1]))||(Je.lineNumber=Number(Lb[0]),Je.columnNumber=Number(Lb[1])):Je.lineNumber=Number(Lb[0]));
var yk={level:"ERROR_LEVEL_UNKNOWN",message:I.message,errorClassName:I.name,sampleWeight:I.sampleWeight};"ERROR"===Ie?yk.level="ERROR_LEVEL_ERROR":"WARNING"===Ie&&(yk.level="ERROR_LEVEL_WARNNING");var ow={isObfuscated:!0,browserStackInfo:Je},vd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(vd.experimentIds=L("FEXP_EXPERIMENTS"));var zk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Rk()&&zk)for(var Yp=p(Object.keys(zk)),Bc=Yp.next();!Bc.done;Bc=Yp.next()){var Zp=Bc.value;vd.kvPairs.push({key:Zp,
value:String(zk[Zp])})}var Ak=I.params;if(Ak){var $p=p(Object.keys(Ak));for(Bc=$p.next();!Bc.done;Bc=$p.next()){var aq=Bc.value;vd.kvPairs.push({key:"client."+aq,value:String(Ak[aq])})}}var bq=L("SERVER_NAME"),cq=L("SERVER_VERSION");bq&&cq&&(vd.kvPairs.push({key:"server.name",value:bq}),vd.kvPairs.push({key:"server.version",value:cq}));Xp={errorMetadata:vd,stackTrace:ow,logMessage:yk}}var dq=Xp;if(!dq)break a;rm("clientError",dq)}if("ERROR"===Ie||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
(Qr(!0),!M("web_fp_via_jspb_and_json")))break c;Qr()}else{if(M("web_fp_via_jspb")&&(Qr(!0),!M("web_fp_via_jspb_and_json")))break b;Qr()}}if(!M("suppress_error_204_logging")){var Ke=I.params||{},cc={urlParams:{a:"logerror",t:"jserror",type:I.name,msg:I.message.substr(0,250),line:I.lineNumber,level:h,"client.name":Ke.name},postParams:{url:L("PAGE_NAME",window.location.href),file:I.fileName},method:"POST"};Ke.version&&(cc["client.version"]=Ke.version);if(cc.postParams){I.stack&&(cc.postParams.stack=
I.stack);for(var eq=p(Object.keys(Ke)),Bk=eq.next();!Bk.done;Bk=eq.next()){var fq=Bk.value;cc.postParams["client."+fq]=Ke[fq]}var Ck=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(Ck)for(var gq=p(Object.keys(Ck)),Dk=gq.next();!Dk.done;Dk=gq.next()){var hq=Dk.value;cc.postParams[hq]=Ck[hq]}var iq=L("SERVER_NAME"),jq=L("SERVER_VERSION");iq&&jq&&(cc.postParams["server.name"]=iq,cc.postParams["server.version"]=jq)}yl(L("ECATCHER_REPORT_HOST","")+"/error_204",cc)}try{ms.add(I.message)}catch(Qx){}ns++}}}}
function us(){for(var a=p(rs),b=a.next();!b.done;b=a.next())if(hm(b.value.toLowerCase()))return!0;return!1}
function vs(a){var b=Ka.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,ja(b))}
;function ws(){this.register=new Map}
function xs(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Jr("ABORTED")}
...
return a.join("")}
;var Bs=y.ytLoggingDocDocumentNonce_;Bs||(Bs=As(),z("ytLoggingDocDocumentNonce_",Bs));var Cs=Bs;var Ds={ci:0,xe:1,He:2,bm:3,fi:4,Fq:5,Rm:6,Jo:7,Yn:8,xo:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function Es(a){this.G=a}
...
z("yt_logging_screen.getCttAuthInfo",Ns);function Os(a,b,c,d){c=void 0===c?0:c;if(a!==L(Gs(c))||b!==L(Hs(c)))if(Ms(a,d,c),Qk(Gs(c),a),Qk(Hs(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new Gj;D(e,1,Cs);D(e,2,a);var f=new ek;ae(f,Gj,111,fk,e);Ur(f)}else rm("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Cs,clientScreenNonce:a})},0)},"requestAnimationFrame"in window)try{window.requestAnimationFrame(b)}catch(e){b()}else b()}
...
Wf:131381,Xf:84517,Yf:83759,Zf:162711,ag:162712,cg:80357,dg:86113,eg:72598,fg:72733,gg:107349,hg:124275,ig:118203,jg:133275,kg:160157,lg:152569,mg:156651,ng:133274,og:160159,pg:160158,qg:133272,rg:133273,sg:133276,tg:144507,ug:143247,vg:156652,wg:143248,xg:143249,yg:143250,zg:143251,Ag:156653,Bg:144401,Dg:117431,Cg:133797,Eg:153964,Fg:128572,Gg:133405,Hg:117429,Ig:117430,Jg:117432,Kg:120080,Lg:117259,Mg:156655,Ng:156654,Og:121692,Pg:145656,Qg:156656,Rg:145655,Sg:145653,Tg:145654,Ug:145657,Vg:132972,
Wg:133051,Xg:133658,Yg:132971,Zg:97615,bh:143359,ah:143356,eh:143361,dh:143358,gh:143360,fh:143357,hh:142303,ih:143353,jh:143354,kh:144479,lh:143355,mh:31402,oh:133624,ph:146477,qh:133623,rh:133622,nh:133621,sh:84774,uh:160801,th:95117,vh:150497,wh:98930,xh:98931,yh:98932,zh:153320,Ah:153321,Bh:43347,Ch:129889,Dh:149123,Eh:45474,Fh:100352,Gh:84758,Hh:98443,Ih:117985,Jh:74613,Kh:155911,Lh:74614,Mh:64502,Nh:136032,Oh:74615,Ph:74616,Qh:122224,Rh:74617,Sh:77820,Th:74618,Uh:93278,Vh:93274,Wh:93275,Xh:93276,
Yh:22110,Zh:29433,ai:133798,bi:132295,di:120541,gi:82047,hi:113550,ii:75836,ji:75837,ki:42352,li:84512,mi:76065,ni:75989,vi:51879,wi:16623,xi:32594,yi:27240,zi:32633,Ai:74858,Bi:156999,Di:3945,Ci:16989,Ei:45520,Fi:25488,Gi:25492,Hi:25494,Ii:55760,Ji:14057,Ki:18451,Li:57204,Mi:57203,Ni:17897,Oi:57205,Pi:18198,Qi:17898,Ri:17909,Si:43980,Ti:46220,Ui:11721,Vi:147994,Wi:49954,Xi:96369,Yi:3854,Zi:151633,aj:56251,bj:159108,cj:25624,dj:152036,uj:16906,vj:99999,wj:68172,xj:27068,yj:47973,zj:72773,Aj:26970,
Bj:26971,Cj:96805,Dj:17752,Ej:73233,Fj:109512,Gj:22256,Hj:14115,Ij:22696,Jj:89278,Kj:89277,Lj:109513,Mj:43278,Nj:43459,Oj:43464,Pj:89279,Qj:43717,Rj:55764,Sj:22255,Tj:147912,Uj:89281,Vj:40963,Wj:43277,Xj:43442,Yj:91824,Zj:120137,ak:96367,bk:36850,ck:72694,dk:37414,ek:36851,gk:124863,fk:121343,hk:73491,ik:54473,jk:166861,kk:43375,lk:46674,mk:143815,nk:139095,pk:144402,qk:149968,rk:149969,sk:32473,tk:72901,uk:72906,vk:50947,wk:50612,xk:50613,yk:50942,zk:84938,Ak:84943,Bk:84939,Ck:84941,Dk:84944,Ek:84940,
Fk:84942,Gk:35585,Hk:51926,Ik:79983,Jk:63238,Kk:18921,Lk:63241,Mk:57893,Nk:41182,Ok:135732,Pk:33424,Qk:22207,Rk:42993,Sk:36229,Tk:22206,Uk:22205,Vk:18993,Wk:19001,Xk:18990,Yk:18991,Zk:18997,al:18725,bl:19003,dl:36874,fl:44763,il:33427,jl:67793,kl:22182,ll:37091,ml:34650,nl:50617,ol:47261,pl:22287,ql:25144,rl:97917,sl:62397,ul:150871,vl:150874,wl:125598,xl:137935,yl:36961,zl:108035,Al:27426,Bl:27857,Cl:27846,Dl:27854,El:69692,Fl:61411,Gl:39299,Hl:38696,Il:62520,Jl:36382,Kl:108701,Ll:50663,Ml:36387,
Nl:14908,Ol:37533,Pl:105443,Ql:61635,Rl:62274,Sl:161670,Tl:133818,Ul:65702,Vl:65703,Wl:65701,Xl:76256,Yl:166382,Zl:37671,am:49953,cm:36216,dm:28237,em:39553,fm:29222,gm:26107,hm:38050,im:26108,km:120745,jm:26109,lm:26110,mm:66881,nm:28236,om:14586,pm:160598,qm:57929,rm:74723,sm:44098,tm:44099,wm:23528,xm:61699,um:134104,vm:134103,ym:59149,zm:101951,Am:97346,Bm:118051,Cm:95102,Dm:64882,Em:119505,Fm:63595,Gm:63349,Hm:95101,Im:75240,Jm:27039,Km:68823,Lm:21537,Mm:83464,Nm:75707,Om:83113,Pm:101952,Qm:101953,
Sm:79610,Tm:125755,Um:24402,Vm:24400,Wm:32925,Ym:57173,Xm:156421,Zm:122502,an:145268,bn:138480,cn:64423,dn:64424,en:33986,fn:100828,gn:129089,hn:21409,mn:135155,nn:135156,pn:135157,qn:135158,rn:158225,sn:135159,tn:135160,un:167651,vn:135161,xn:135162,yn:135163,wn:158226,zn:158227,An:135164,Bn:135165,Cn:135166,jn:11070,kn:11074,ln:17880,Dn:14001,Fn:30709,Gn:30707,Hn:30711,In:30710,Jn:30708,En:26984,Kn:146143,Ln:63648,Mn:63649,Nn:111059,On:5754,Pn:20445,Qn:151308,Rn:151152,Un:130975,Tn:130976,Sn:167637,
Vn:110386,Wn:113746,Xn:66557,Zn:17310,ao:28631,bo:21589,co:164817,eo:168011,fo:154946,ho:68012,jo:162617,ko:60480,lo:138664,mo:141121,no:164502,oo:31571,po:141978,qo:150105,ro:150106,so:150107,to:150108,uo:76980,vo:41577,wo:45469,yo:38669,zo:13768,Ao:13777,Bo:141842,Co:62985,Do:4724,Eo:59369,Fo:43927,Go:43928,Ho:12924,Io:100355,Lo:56219,Mo:27669,No:10337,Ko:47896,Oo:122629,Qo:139723,Po:139722,Ro:121258,So:107598,To:127991,Uo:96639,Vo:107536,Wo:130169,Xo:96661,Yo:145188,Zo:96658,ap:116646,bp:159428,
cp:121122,ep:96660,fp:127738,gp:127083,hp:155281,ip:162959,jp:163566,kp:147842,lp:104443,mp:96659,np:147595,qp:106442,rp:162776,sp:134840,tp:63667,up:63668,vp:63669,wp:130686,xp:147036,yp:78314,zp:147799,Ap:148649,Bp:55761,Cp:127098,Dp:134841,Ep:96368,Fp:67374,Gp:48992,Hp:146176,Ip:49956,Jp:31961,Kp:26388,Lp:23811,Mp:5E4,Np:126250,Op:96370,Pp:47355,Qp:47356,Rp:37935,Sp:45521,Tp:21760,Up:83769,Vp:49977,Wp:49974,Xp:93497,Yp:93498,Zp:34325,aq:140759,bq:115803,cq:123707,fq:100081,gq:35309,hq:68314,iq:25602,
jq:100339,kq:143516,lq:59018,mq:18248,nq:50625,oq:9729,pq:37168,qq:37169,rq:21667,sq:16749,tq:18635,uq:39305,wq:18046,xq:53969,yq:8213,zq:93926,Aq:102852,Bq:110099,Cq:22678,Dq:69076,Eq:137575,Gq:139224,Hq:100856,Iq:154430,Jq:17736,Kq:3832,Lq:147111,Mq:55759,Nq:64031,Tq:93044,Uq:93045,Wq:34388,Vq:167841,Xq:17657,Yq:17655,Zq:39579,br:39578,dr:77448,er:8196,fr:11357,gr:69877,hr:8197,ir:168501,jr:156512,kr:161613,lr:156509,mr:161612,pr:161614,qr:82039};function Ss(){var a=vb(Ts),b;return(new Af(function(c,d){a.onSuccess=function(e){rl(e)?c(new Us(e)):d(new Vs("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
;function $s(){return vg()||gm&&hm("applewebkit")&&!hm("version")&&(!hm("safari")||hm("gsa/"))||Nc&&hm("version/")?!0:L("EOM_VISITOR_DATA")?!1:!0}
...
function bl(){var a=et();if(void 0!==a)return Ff(a);dt||(dt=Ss().then(ft).pb(function(b){return gt(2,b)}));
return dt}
function ft(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ct;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ct;a=a.id;cl(a);dt=Xs(a);ht(18E5,2);return a}
function gt(a,b){b=new bt(b);cl("");dt=Ys(b);0<a&&ht(12E4,a-1);throw b;}
function ht(a,b){sl(function(){Ss().then(ft,function(c){return gt(b,c)}).pb(db)},a)}
function jt(){try{var a=B("yt.ads.biscotti.getId_");return a?a():bl()}catch(b){return Ff(b)}}
;function kt(a){if("1"!=tb(L("PLAYER_VARS",{}))){a&&al();try{jt().then(function(){},function(){}),sl(kt,18E5)}catch(b){Zk(b)}}}
;function lt(){var a=Ml.getInstance(),b=Pl(119),c=1<window.devicePixelRatio;if(document.body&&oi(document.body,"exp-invert-logo"))if(c&&!oi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!oi(d,"inverted-hdpi")){var e=mi(d);ni(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&oi(document.body,"inverted-hdpi")&&pi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Ql(b)||0;d=c?d|67108864:d&-67108865;0==d?delete Ll[b]:(c=d.toString(16),Ll[b]=
...
;function rt(){this.h={};if(this.i=Kl()){var a=tg.get("CONSISTENCY",void 0);a&&st(this,{encryptedTokenJarContents:a})}}
...
l=ut.prototype;l.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.i?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=Math.floor(1E7*this.i.coords.latitude),a.client.locationInfo.longitudeE7=Math.floor(1E7*this.i.coords.longitude),a.client.locationInfo.horizontalAccuracyMeters=Math.round(this.i.coords.accuracy),a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
l.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.i=void 0,"TVHTML5"===L("INNERTUBE_CLIENT_NAME")?(this.h=vt(this))&&this.h.set("yt-location-playability-token",a,15552E3):Il("YT_CL",JSON.stringify({loctok:a}),15552E3,tt,!0))};
function vt(a){return void 0===a.h?new im("yt-client-location"):a.h}
l.clearLocationPlayabilityToken=function(a){"TVHTML5"===a?(this.h=vt(this))&&this.h.remove("yt-location-playability-token"):Jl("YT_CL")};
...
p(Object.entries(A));for(var O=F.next();!O.done;O=F.next()){var N=p(O.value),Q=N.next().value,ca=N.next().value;A=Q;E=ca;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:A,value:""+E})}}catch(sb){ss(sb)}F=g}else ss(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(O=this.h(a)){this.i(F,O,b);var U;b="/youtubei/v1/"+Ct(this.j());(O=null==(U=ar(a.commandMetadata,nj))?void 0:U.apiUrl)&&(b=O);U=b;(b=L("INNERTUBE_HOST_OVERRIDE"))&&(U=String(b)+String(pc(U)));b=
...
;function Mt(a,b){Eo.call(this,1,arguments);this.timer=b}
u(Mt,Eo);var Nt=new Fo("aft-recorded",Mt);var Ot=window;function Pt(){this.timing={};this.clearResourceTimings=function(){};
...
function du(a){var b=Tt("_start",a),c=St(a);b&&c&&!Qt&&(Ko(Nt,new Mt(Math.round(c-b),a)),Qt=!0)}
...
Au.prototype.tick=function(a,b,c,d){Cu(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new bk,D(d,1,a),D(d,2,b),a=new ek,ae(a,bk,5,fk,d),Ur(a,c)):rm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
Au.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Cu(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,rm("latencyActionInfo",a,{cttAuthInfo:c}))};
Au.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Cu(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new ek,ae(c,Xj,7,fk,a),Ur(c,b))};
Au.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Cu(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,rm("latencyActionSpan",a,{cttAuthInfo:c}))};
function Cu(a,b){zu[b]=zu[b]||{count:0};var c=zu[b];c.count++;c.time=R();a.h||(a.h=Zl(function(){var d=R(),e;for(e in zu)zu[e]&&6E4<d-zu[e].time&&delete zu[e];a&&(a.h=0)},5E3));
...
D(a,1,e),e=new ek,ae(e,Vj,6,fk,a),Ur(e,b)):rm("latencyActionBaselined",{clientActionNonce:e},b))):Bu().tick(a,e,b,f);du(c);return d}
function Ku(){var a=cu();requestAnimationFrame(function(){setTimeout(function(){a===cu()&&Z("ol",void 0,void 0)},0)})}
function Fu(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=oq+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
...
function Su(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?ot:c;var d=xt(b,a.m);if(!d)return Ff(new P("Error: No request builder found for command.",b));var e=d.m(b,void 0,c);return e?new Af(function(f){var g,h,k;return x(function(m){if(1==m.h){h="cors"===(null==(g=e.wa)?void 0:g.mode)?"cors":void 0;if(a.l.ud){var q=e.config,r;q=null==q?void 0:null==(r=q.Za)?void 0:r.sessionIndex;r=nt({sessionIndex:q});k=Object.assign({},Tu(h),r);return m.u(2)}return v(m,Uu(e.config,
h),3)}2!=m.h&&(k=m.i);f(Vu(a,e,k));m.h=0})}):Ff(new P("Error: Failed to build request for command.",b))}
function Wu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Mr)?0:d.Pr)&&a.j){d=p(Ou);for(var e=d.next();!e.done;e=d.next())e=e.value,a.j[e]&&a.j[e].handleResponse(b,c)}}
function Vu(a,b,c){var d,e,f,g,h,k,m,q,r,w,t,A,E,F,O,N,Q,ca,U,sb,Wa,oa,I,ma,ea,Ge,He,sd;return x(function(ra){switch(ra.h){case 1:ra.u(2);break;case 3:if((d=ra.i)&&!d.isExpired())return ra.return(Promise.resolve(d.h()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Ir(b.ga.context);if(null==(m=a.i)||!m.Nr(b.input,b.ga)){ra.u(4);break}return v(ra,a.i.Dr(b.input,b.ga),5);case 5:return q=ra.i,M("kevlar_process_local_innertube_responses_killswitch")||
...
case 6:if((U=ra.i)&&"error"in U&&(null==(sb=U)?0:null==(Wa=sb.error)?0:Wa.details))for(oa=U.error.details,I=p(oa),ma=I.next();!ma.done;ma=I.next())ea=ma.value,(Ge=ea["@type"])&&-1<Pu.indexOf(Ge)&&(delete ea["@type"],U=ea);t&&a.h.has(t)&&a.h.delete(t);(null==(He=b.config)?0:He.hd)&&Z(b.config.hd);if(U||null==(sd=a.i)||!sd.vr(b.input,b.ga)){ra.u(7);break}return v(ra,a.i.Cr(b.input,b.ga),8);case 8:U=ra.i;case 7:return Wu(a,U,b),ra.return(U||void 0)}})}
function Uu(a,b){var c,d,e,f;return x(function(g){if(1==g.h){e=null==(c=a)?void 0:null==(d=c.Za)?void 0:d.sessionIndex;var h=nt({sessionIndex:e});if(!(h instanceof Af)){var k=new Af(db);Bf(k,2,h);h=k}return v(g,h,2)}f=g.i;return g.return(Promise.resolve(Object.assign({},Tu(b),f)))})}
...
;var Xu=new Pq("INNERTUBE_TRANSPORT_TOKEN");var Yu=["share/get_web_player_share_panel"],Zu=["feedback"],$u=["notification/modify_channel_preference"],av=["browse/edit_playlist"],bv=["subscription/subscribe"],cv=["subscription/unsubscribe"];function dv(){}
u(dv,Dt);dv.prototype.j=function(){return bv};
dv.prototype.h=function(a){return ar(a,Kk)||void 0};
...
ev.prototype.h=function(a){return ar(a,Jk)||void 0};
...
fv.prototype.h=function(a){return ar(a,qj)||void 0};
...
gv.prototype.h=function(a){return ar(a,Ik)||void 0};
...
hv.prototype.h=function(a){return ar(a,Hk)||void 0};
...
iv.prototype.h=function(a){return ar(a,Gk)};
iv.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Rq=new Pq("NETWORK_SLI_TOKEN");function jv(a){this.h=a}
...
a.redirected||a.ok?this.h&&this.h.success():(this.h&&this.h.zr(),b=b.then(function(c){ts(new P("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
jv[Oq]=[new Qq];var kv=new Pq("NETWORK_MANAGER_TOKEN");var lv;function mv(a){Eo.call(this,1,arguments);this.csn=a}
u(mv,Eo);var No=new Fo("screen-created",mv),nv=[],pv=ov,qv=0;function rv(a,b,c,d,e,f,g){function h(){ts(new P("newScreen() parent element does not have a VE - rootVe",b))}
var k=pv(),m=new Es({veType:b,youtubeData:f,jspbYoutubeData:void 0});f={sequenceGroup:k};e&&(f.cttAuthInfo=e);M("il_via_jspb")?(e=Lj((new Kj).i(k),m.getAsJspb()),c&&c.visualElement?(m=new Mj,c.clientScreenNonce&&D(m,2,c.clientScreenNonce),Nj(m,c.visualElement.getAsJspb()),g&&D(m,4,gk[g]),G(e,Mj,5,m)):c&&h(),d&&D(e,3,d),Zr(e,f,a)):(e={csn:k,pageVe:m.getAsJson()},c&&c.visualElement?(e.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(e.implicitGesture.gestureType=
g)):c&&h(),d&&(e.cloneCsn=d),a?Or("screenCreated",e,a,f):rm("screenCreated",e,f));Ko(No,new mv(k));return k}
function sv(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:Ns(b)||void 0,
sequenceGroup:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(qb(g)||!g.trackingParams&&!g.veType)&&ts(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=Qj((new Oj).i(b),c.getAsJspb());ib(e,function(k){k=k.getAsJspb();ce(h,3,Fj,k)});
"UNDEFINED_CSN"===b?tv("visualElementAttached",f,void 0,h):$r(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:ib(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"===b?tv("visualElementAttached",f,c):a?Or("visualElementAttached",c,a,f):rm("visualElementAttached",c,f)}
function uv(a,b,c,d,e,f){vv(a,b,c,e,f)}
function vv(a,b,c,d,e){var f={cttAuthInfo:Ns(b)||void 0,sequenceGroup:b};M("il_via_jspb")?(d=(new Tj).i(b),c=c.getAsJspb(),c=G(d,Fj,2,c),c=D(c,4,1),e&&G(c,Ij,3,e),"UNDEFINED_CSN"===b?tv("visualElementShown",f,void 0,c):Vr(c,f,a)):(e={csn:b,ve:c.getAsJson(),eventType:1},d&&(e.clientData=d),"UNDEFINED_CSN"===b?tv("visualElementShown",f,e):a?Or("visualElementShown",e,a,f):rm("visualElementShown",e,f))}
...
function tv(a,b,c,d){nv.push({Eb:a,payload:c,la:d,options:b});qv||(qv=Oo())}
function Po(a){if(nv){for(var b=p(nv),c=b.next();!c.done;c=b.next())if(c=c.value,M("il_via_jspb")&&c.la)switch(c.la.i(a.csn),c.Eb){case "screenCreated":Zr(c.la,c.options);break;case "visualElementAttached":$r(c.la,c.options);break;case "visualElementShown":Vr(c.la,c.options);break;case "visualElementHidden":Wr(c.la,c.options);break;case "visualElementGestured":Xr(c.la,c.options);break;case "visualElementStateChanged":Yr(c.la,c.options);break;default:ts(new P("flushQueue unable to map payloadName to JSPB setter"))}else c.payload&&
(c.payload.csn=a.csn,rm(c.Eb,c.payload,c.options));nv.length=0}qv=0}
;function wv(){this.l=new Set;this.h=new Set;this.m=new Map;this.client=mq;this.csn=null}
...
yv.prototype.i=function(a){M("safe_logging_library_killswitch")?this.client=a:Yk(xv().i).bind(xv())(a)};
yv.prototype.clear=function(){M("safe_logging_library_killswitch")?(this.j.clear(),this.h.clear(),this.l.clear(),this.csn=null):Yk(xv().clear).bind(xv())()};function Av(){this.j=new Set;this.h=new Set;this.l=new Map}
...
Bv.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Ls(void 0===c?0:c)){a=this.client;var e=Fs(d);d={cttAuthInfo:Ns(c)||void 0,sequenceGroup:c};M("il_via_jspb")?(b=(new Rj).i(c),e=e.getAsJspb(),b=G(b,Fj,2,e),D(b,4,gk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK),"UNDEFINED_CSN"===c?tv("visualElementGestured",d,void 0,b):Xr(b,d,a)):(e={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(e.clientData=b),"UNDEFINED_CSN"===
c?tv("visualElementGestured",d,e):a?Or("visualElementGestured",e,a,d):rm("visualElementGestured",e,d));b=!0}else b=!1;else b=!1;return b};
Bv.prototype.visualElementStateChanged=function(a,b,c){c=void 0===c?0:c;0===c&&this.j.has(c)?this.v.push([a,b]):Ev(this,a,b,c)};
function Ev(a,b,c,d){d=void 0===d?0:d;var e=Ls(d);d=b||Js(d);e&&d&&(a=a.client,b={cttAuthInfo:Ns(e)||void 0,sequenceGroup:e},M("il_via_jspb")?(c=new Uj,c.i(e),d=d.getAsJspb(),G(c,Fj,2,d),"UNDEFINED_CSN"===e?tv("visualElementStateChanged",b,void 0,c):Yr(c,b,a)):(c={csn:e,ve:d.getAsJson(),clientData:c},"UNDEFINED_CSN"===e?tv("visualElementStateChanged",b,c):a?Or("visualElementStateChanged",c,a,b):rm("visualElementStateChanged",c,b)))}
...
function Gv(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.bd?c.bd:c.layer;var e=Ls(d);d=Js(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=rv(a.client,b,f,c.Vb,c.cttAuthInfo,g,c.Ar)}catch(m){vs(m,{Kr:b,rootVe:d,Hr:void 0,wr:e,Gr:f,Vb:c.Vb});ss(m);return}Os(k,b,c.layer,c.cttAuthInfo);
if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Ds));for(f=b.next();!f.done;f=b.next())if(Ls(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:Ns(e)||void 0,sequenceGroup:e,endOfSequence:g},M("il_via_jspb")?(h=(new Sj).i(e),d=d.getAsJspb(),d=G(h,Fj,2,d),D(d,4,g?16:8),"UNDEFINED_CSN"===e?tv("visualElementHidden",f,void 0,d):Wr(d,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"===e?tv("visualElementHidden",f,d):b?Or("visualElementHidden",
d,b,f):rm("visualElementHidden",d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");Ju({clientScreenNonce:k});d=Av.getInstance();M("use_ts_visibilitylogger")?(d=zv(),M("safe_logging_library_killswitch")?(d.clear(),d.csn=Ls()):Yk(xv().j).bind(xv())()):d.clear();d=Js(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,M("safe_logging_library_killswitch")?vv(void 0,e,d):Yk(uv)(void 0,e,d,void 0,void 0,void 0));a.j.delete(c.layer||
0);a.l=void 0;e=p(a.s);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Dv(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){ss(m)}}for(c=a.m.length=0;c<a.M.length;c++){e=a.M[c];try{e()}catch(m){ss(m)}}}
;function Hv(){var a,b,c;return x(function(d){if(1==d.h)return a=Wq().resolve(Xu),a?v(d,Su(a),2):(ts(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),d.return(void 0));if(b=d.i){if(b.errorMetadata)return ts(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),d.return(void 0);c=b.xr;return d.return(c)}ts(Error("Network request to get Datasync IDs failed."));return d.return(void 0)})}
...
return a.return(Jv)})}
function Mv(a){var b,c,d,e,f,g,h;x(function(k){if(1==k.h)return v(k,Lv(),2);if(3!=k.h){if(!k.i)return k.return(!1);b=[];return v(k,Iv.keys(),3)}c=k.i;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=Kv(f),h=g.datasyncId,!h||a.includes(h)||b.push(Iv.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function Nv(){var a,b,c,d,e,f,g;return x(function(h){if(1==h.h)return v(h,Lv(),2);if(3!=h.h){if(!h.i)return h.return(!1);a=fm("cache contains other");return v(h,Iv.keys(),3)}b=h.i;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=Kv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
...
function Rv(){if(!Ov())return!1;var a=fm(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=Pv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function Sv(){Hv().then(function(a){a&&(Gn(a),Mv(a),Qv(a))})}
function Tv(){var a=new qp;ei.S(function(){var b,c,d,e;return x(function(f){switch(f.h){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=fm("clear");if(b.startsWith("V")){var g=[b];Gn(g);Mv(g);Qv(g);return f.return()}c=Rv();return v(f,Nv(),3);case 3:return d=f.i,v(f,Hn(),4);case 4:if(e=f.i,!c&&!d&&!e)return f.return();case 2:a.U()?Sv():a.l.add("publicytnetworkstatus-online",Sv,!0,void 0,void 0),f.h=0}})})}
...
function aw(a,b,c){c=void 0===c?null:c;var d=bw(a),e=document.getElementById(d),f=e&&Wv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Iq(d,b),b=""+Sa(b),cw[b]=f),g||(e=dw(a,d,function(){Wv(e,"loaded")||(Uv(e),Lq(d),sl(Za(Mq,d),0))},c)))}
...
function ew(a){a=bw(a);var b=document.getElementById(a);b&&(Mq(a),b.parentNode.removeChild(b))}
function fw(a,b){a&&b&&(a=""+Sa(b),(a=cw[a])&&Kq(a))}
...
;function kw(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?dm():d;this.l=c;this.j=d;this.i=new Eh;this.h=a;a={};c=p(this.h.entries());for(d=c.next();!d.done;a={Ea:a.Ea,Qa:a.Qa},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.Qa=d;a.Ea=e;d=function(f){return function(){f.Ea.Ab();b.h[f.Qa].lb=!0;b.h.every(function(g){return!0===g.lb})&&b.i.resolve()}}(a);
e=$l(d,lw(this,a.Ea));this.h[a.Qa]=Object.assign({},a.Ea,{Ab:d,jobId:e})}}
function mw(a){var b=Array.from(a.h.keys()).sort(function(d,e){return lw(a,a.h[e])-lw(a,a.h[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.h[c.value],void 0===c.jobId||c.lb||(a.j.da(c.jobId),$l(c.Ab,10))}
...
function qw(a,b,c){return function(){var d=Ka.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
var vw;u(uw,tw);uw.prototype.l=function(){if(M("web_fp_via_jspb")){var a=new Ej,b=Ls();b&&D(a,1,b);b=new ek;ae(b,Ej,380,fk,a);Ur(b);M("web_fp_via_jspb_and_json")&&rm("finalPayload",{csn:Ls()})}else rm("finalPayload",{csn:Ls()})};
...
z("ytglobal.storageClass_",ww);function pm(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
...
u(Aw,J);Aw.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.i&&(a.channel=this.i);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){$k(d)}}};
...
l=Bw.prototype;l.dd=function(a,b,c){"addEventListener"===a&&b?this.zb(b[0],c):this.Kb(a,b,c)};
l.Kb=function(){};
...
this.qd.bind(this))}
u(Jw,Bw);l=Jw.prototype;
l.Kb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Gw(a)){var d=b;if(Ra(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Hw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
...
l.zb=function(a,b){("onReady"===a||"onError"===a&&this.l)&&this.api.logApiCall(a+" invocation",b);this.api.logApiCall(a+" registration",b);Bw.prototype.zb.call(this,a,b)};
l.sb=function(a,b){var c=this,d=Bw.prototype.sb.call(this,a,b);return function(e){c.api.logApiCall(a+" invocation",b);d(e)}};
l.onReady=function(){var a=this.Oc.bind(this);this.h.j=a;a=this.api.getVideoData();if(!a.isPlayable){this.l=!0;a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?Ew[a]||b:b).toString())}};
...
l.ld=function(a){Cw(this,{playbackQuality:a})};
l.md=function(a){Cw(this,{playbackRate:a})};
...
l.pd=function(){Cw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
l.qd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Cw(this,a)};
l.dispose=function(){Bw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Kw(a){J.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.kc,this)}
u(Kw,J);l=Kw.prototype;l.start=function(){this.started||this.h()||(this.started=!0,this.connection.xa("RECEIVING"))};
...
l.B=function(){var a=this.connection;a.h()||Bi(a.i,"command",this.kc,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);J.prototype.B.call(this)};function Nw(a,b){Kw.call(this,b);this.api=a;this.start()}
...
Pw.prototype.B=function(){this.j=this.l=null;Ow.prototype.B.call(this)};function Qw(a,b,c){J.call(this);this.i=a;this.origin=c;this.j=vq(window,"message",this.l.bind(this));this.connection=new Pw(this,a,b);ue(this,this.connection)}
...
l.Ib=function(a){se(this.h);this.h=a};function Uw(){var a=B("yt.abuse.playerAttLoader");return a&&["bgvma","bgvmb","bgvmc"].every(function(b){return b in a})?a:null}
...
function bx(a){var b=cx(a),c=document.getElementById(b),d=c&&Wv(c,"loaded");d||c&&!d||(c=dx(a,b,function(){Wv(c,"loaded")||(Uv(c),Lq(b),sl(Za(Mq,b),0))}))}
...
u(gx,J);l=gx.prototype;l.getId=function(){return this.s};
l.loadNewVideoConfig=function(a){if(!this.h()){this.T&&(window.clearTimeout(this.T),this.T=0);var b=a||{};b instanceof Zw||(b=new Zw(b));this.config=b;this.setConfig(a);kx(this);this.isReady()&&lx(this)}};
...
function ix(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Lq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){Lq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=nx(this,b);d&&(0<=fb(this.Xa,a)||this.i[a]||(b=yx(this,a),this.o&&this.o(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&sl(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.h()||(b=nx(this,b))&&Bi(this.K,a,b)};
...
rb(a.I,String(e))};
return c}
l.getPlayerType=function(){return this.P||(px(this)?"html5":null)};
...
l.cancel=function(){this.F&&fw(qx(this),this.F);window.clearTimeout(this.Ga);this.O=!1};
l.B=function(){sx(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){ss(b)}this.ja=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.sa=this.config=this.api=null;delete this.m;delete this.j;J.prototype.B.call(this)};
...
;function Kx(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;$s()&&Il(a,b,c)}
...
d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Dx=Bx(a,c);Dx.addEventListener("onVideoDataChange",Gx);Dx.addEventListener("onReady",Ix);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?Fx=new Jw(Dx):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Ex=new Qw(window.parent,a,b),Fx=new Nw(Dx,Ex.connection));iw();M("ytidb_create_logger_embed_killswitch")||M("embeds_web_disable_nwl")||om();a={};vw||(vw=new uw);vw.install((a.flush_logs={callback:function(){wr()}},
a));
M("embeds_web_disable_nwl")||lq();M("ytidb_clear_embedded_player")&&ei.S(function(){var e;if(!lv){var f=Wq(),g={Fb:kv,uc:jv};f.h.set(g.Fb,g);g={Tb:{feedbackEndpoint:zt(fv),modifyChannelNotificationPreferenceEndpoint:zt(gv),playlistEditEndpoint:zt(hv),subscribeEndpoint:zt(dv),unsubscribeEndpoint:zt(ev),webPlayerShareEntityServiceEndpoint:zt(iv)}};var h=ut.getInstance(),k={};h&&(k.client_location=h);if(void 0===m){mt.h||(mt.h=new mt);var m=mt.h}void 0===e&&(e=f.resolve(kv));Ru(g,e,m,k);m={Fb:Xu,vc:Qu.h};
f.h.set(m.Fb,m);lv=f.resolve(Xu)}Tv()})});
var Mx=Yk(function(){Ku();lt();Bv.h||(Bv.h=new Bv);var a=Bv.h;var b=16623;var c=void 0===c?{}:c;Object.values(Rs).includes(b)||(ts(new P("createClientScreen() called with a non-page VE",b)),b=83769);c.isHistoryNavigation||a.h.push({rootVe:b,key:c.key||""});a.o=[];a.v=[];c.Wb?Fv(a,b,c):Gv(a,b,c)}),Nx=Yk(function(a){M("embeds_web_enable_load_player_from_page_show")&&!a.persisted&&(Ku(),lt())}),Ox=Yk(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?Jx():a.persisted||(M("embeds_web_enable_load_player_from_page_show")?
Jx():Zc?setTimeout(function(){Jx()},0):Jx())}),Px=Yk(Jx);
